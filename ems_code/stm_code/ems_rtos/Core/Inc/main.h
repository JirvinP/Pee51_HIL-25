...
#define SG_RDY_Pin GPIO_PIN_3
#define SG_RDY_GPIO_Port GPIOF
#define SG_RDY_EXTI_IRQn EXTI3_IRQn
...
#define THREAD_2_Pin GPIO_PIN_14
#define THREAD_2_GPIO_Port GPIOD
#define THREAD_1_Pin GPIO_PIN_15
#define THREAD_1_GPIO_Port GPIOD
#define LED_RED_Pin GPIO_PIN_4
#define LED_RED_GPIO_Port GPIOG
#define UCPD_FLT_Pin GPIO_PIN_7
#define UCPD_FLT_GPIO_Port GPIOG
#define THREAD_3_Pin GPIO_PIN_7
#define THREAD_3_GPIO_Port GPIOC
